...
export const MsgSendToEth = {
  ...
  fromAmino(object: MsgSendToEthAmino): MsgSendToEth {
    ...
    if (object.chain_fee !== undefined && object.chain_fee !== null) {
      message.chainFee = Coin.fromAmino(object.chain_fee);
    }
    return message;
  },
...
export const MsgConfirmLogicCall = {
  ...
  fromAmino(object: MsgConfirmLogicCallAmino): MsgConfirmLogicCall {
    ...
    if (object.invalidation_id !== undefined && object.invalidation_id !== null) {
      message.invalidationId = object.invalidation_id;
    }
...
export const MsgExecuteIbcAutoForwards = {
  ...
  fromAmino(object: MsgExecuteIbcAutoForwardsAmino): MsgExecuteIbcAutoForwards {
    const message = createBaseMsgExecuteIbcAutoForwards();
    if (object.forwards_to_clear !== undefined && object.forwards_to_clear !== null) {
      message.forwardsToClear = BigInt(object.forwards_to_clear);
    }
...
export const MsgSubmitBadSignatureEvidence = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgSubmitBadSignatureEvidence {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.subject = (EthereumSigned_InterfaceDecoder(reader) as Any);
          break;
        case 2:
          message.signature = reader.string();
          break;
  ...
  fromAmino(object: MsgSubmitBadSignatureEvidenceAmino): MsgSubmitBadSignatureEvidence {
    ...
    if (object.subject !== undefined && object.subject !== null) {
      message.subject = EthereumSigned_FromAmino(object.subject);
    }
    if (object.signature !== undefined && object.signature !== null) {
      message.signature = object.signature;
    }
...
export const EventBatchCreated = {
  ...
  fromAmino(object: EventBatchCreatedAmino): EventBatchCreated {
    ...
    if (object.batch_nonce !== undefined && object.batch_nonce !== null) {
      message.batchNonce = object.batch_nonce;
    }
    return message;
  },
...
export const EventBatchConfirmKey = {
  ...
  fromAmino(object: EventBatchConfirmKeyAmino): EventBatchConfirmKey {
    ...
    if (object.batch_confirm_key !== undefined && object.batch_confirm_key !== null) {
      message.batchConfirmKey = object.batch_confirm_key;
    }
    return message;
  },
...
export const EventClaim = {
  ...
  fromAmino(object: EventClaimAmino): EventClaim {
    ...
    if (object.claim_hash !== undefined && object.claim_hash !== null) {
      message.claimHash = object.claim_hash;
    }
...
export const EventMultisigUpdateRequest = {
  ...
  fromAmino(object: EventMultisigUpdateRequestAmino): EventMultisigUpdateRequest {
    ...
    if (object.multisig_id !== undefined && object.multisig_id !== null) {
      message.multisigId = object.multisig_id;
    }
    if (object.nonce !== undefined && object.nonce !== null) {
      message.nonce = object.nonce;
    }
...
export const EventOutgoingLogicCallCanceled = {
  ...
  fromAmino(object: EventOutgoingLogicCallCanceledAmino): EventOutgoingLogicCallCanceled {
    const message = createBaseEventOutgoingLogicCallCanceled();
    if (object.logic_call_invalidation_id !== undefined && object.logic_call_invalidation_id !== null) {
      message.logicCallInvalidationId = object.logic_call_invalidation_id;
    }
    if (object.logic_call_invalidation_nonce !== undefined && object.logic_call_invalidation_nonce !== null) {
      message.logicCallInvalidationNonce = object.logic_call_invalidation_nonce;
    }
    return message;
  },
...
export const EventSendToEthFeeCollected = {
  ...
  fromAmino(object: EventSendToEthFeeCollectedAmino): EventSendToEthFeeCollected {
    ...
    if (object.send_amount !== undefined && object.send_amount !== null) {
      message.sendAmount = object.send_amount;
    }
